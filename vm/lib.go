	...
	Packages = map[string]*File{
		...
		"math": &File{
			...
			Constants: map[string]*ast.Literal{
				"E":       &ast.Literal{"number", "2.71828182845904523536028747135266249775724709369995957496696763", nil, nil, "lib/math/constants.ok:1:7"},
				"Ln10":    &ast.Literal{"number", "2.30258509299404568401799145468436420760110148862877297603332790", nil, nil, "lib/math/constants.ok:11:8"},
				"Ln2":     &ast.Literal{"number", "0.693147180559945309417232121458176568075500134360255254120680009", nil, nil, "lib/math/constants.ok:10:8"},
				"Phi":     &ast.Literal{"number", "1.61803398874989484820458683436563811772030917980576286213544862", nil, nil, "lib/math/constants.ok:3:7"},
				"Pi":      &ast.Literal{"number", "3.14159265358979323846264338327950288419716939937510582097494459", nil, nil, "lib/math/constants.ok:2:7"},
				"Sqrt2":   &ast.Literal{"number", "1.41421356237309504880168872420969807856967187537694807317667974", nil, nil, "lib/math/constants.ok:5:11"},
				"SqrtE":   &ast.Literal{"number", "1.64872127070012814684865078781416357165377610071014801157507931", nil, nil, "lib/math/constants.ok:6:11"},
				"SqrtPhi": &ast.Literal{"number", "1.27201964951406896425242246173749149171560804184009624861664038", nil, nil, "lib/math/constants.ok:8:11"},
				"SqrtPi":  &ast.Literal{"number", "1.77245385090551602729816748334114518279754945612238712821380779", nil, nil, "lib/math/constants.ok:7:11"},
			},
		},
		"reflect": &File{
			Imports: nil,
			Funcs: map[string]*CompiledFunc{
				...
				"hasPrefix": &CompiledFunc{
					...
					Instructions: []Instruction{
						...
						&JumpUnless{"5", 5},
						&Assign{"6", &ast.Literal{"bool", "false", nil, nil, "lib/reflect/strings.ok:6:16"}, ""},
						&Return{Registers{"6"}},
						&Assign{"7", &ast.Literal{"number", "0", nil, nil, "lib/reflect/strings.ok:9:13"}, ""},
						&Assign{"i", nil, "7"},
						&Len{"prefix", "8"},
						...
						&NotEqual{"10", "11", "12"},
						&JumpUnless{"12", 16},
						&Assign{"13", &ast.Literal{"bool", "false", nil, nil, "lib/reflect/strings.ok:11:20"}, ""},
						&Return{Registers{"13"}},
						&Assign{"14", &ast.Literal{"number", "1", nil, nil, ""}, ""},
						&Add{"i", "14", "i"},
						&Jump{8},
						&Assign{"15", &ast.Literal{"bool", "true", nil, nil, "lib/reflect/strings.ok:15:12"}, ""},
						&Return{Registers{"15"}},
					},
					Registers: 15,
					Variables: map[string]string{
		...
		"strings": &File{
			...
			Funcs: map[string]*CompiledFunc{
				...
				"PadLeft": &CompiledFunc{
					...
					Instructions: []Instruction{
						...
						&Assign{"6", &ast.Literal{"string", "", nil, nil, "lib/strings/pad.ok:10:34"}, ""},
						&Equal{"pad", "6", "7"},
						&Or{"5", "7", "8"},
						&JumpUnless{"8", 6},
						&Return{Registers{"s"}},
				...
				"PadRight": &CompiledFunc{
					...
					Instructions: []Instruction{
						&Len{"s", "4"},
						&GreaterThanEqualNumber{"4", "toLen", "5"},
						&Assign{"6", &ast.Literal{"string", "", nil, nil, "lib/strings/pad.ok:20:34"}, ""},
						&Equal{"pad", "6", "7"},
						&Or{"5", "7", "8"},
						&JumpUnless{"8", 6},
						&Return{Registers{"s"}},
				...
				"Substr": &CompiledFunc{
					...
					Instructions: []Instruction{
						&Assign{"4", &ast.Literal{"string", "", nil, nil, "lib/strings/substr.ok:4:9"}, ""},
						&Assign{"r", nil, "4"},
						...
						&CastString{"6", "7"},
						&Concat{"r", "7", "r"},
						&Assign{"8", &ast.Literal{"number", "1", nil, nil, ""}, ""},
						&Add{"i", "8", "i"},
						&Jump{2},
						&Return{Registers{"r"}},
					},
				...
				"createPad": &CompiledFunc{
					...
					Instructions: []Instruction{
						...
						&Assign{"6", &ast.Literal{"number", "0", nil, nil, "lib/strings/pad.ok:28:50"}, ""},
				...
				"substrFrom": &CompiledFunc{
					...
					Instructions: []Instruction{
						&Assign{"3", &ast.Literal{"string", "", nil, nil, "lib/strings/trim.ok:53:14"}, ""},
						&Assign{"result", nil, "3"},
						&Len{"s", "4"},
			...
			FuncDefs: map[string]*ast.Func{
				...
				"PadLeft": &ast.Func{
					...
					Arguments: []*ast.Argument{
						&ast.Argument{"s", "string"},
						&ast.Argument{"pad", "string"},
						&ast.Argument{"toLen", "number"},
					},
					Returns: []string{"string"},
				...
				"Substr": &ast.Func{
					...
					Arguments: []*ast.Argument{
						&ast.Argument{"s", "string"},
						&ast.Argument{"fromIndex", "number"},
						&ast.Argument{"toIndex", "number"},
					},
					Returns: []string{"string"},
				...
				"max": &ast.Func{
					Name: "max",
					Arguments: []*ast.Argument{
						&ast.Argument{"a", "number"},
						&ast.Argument{"b", "number"},
					},
					Returns: []string{"number"},
